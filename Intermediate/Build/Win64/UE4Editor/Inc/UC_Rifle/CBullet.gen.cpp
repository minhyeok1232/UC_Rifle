...
#include "UC_Rifle/Weapons/CBullet.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	UC_RIFLE_API UClass* Z_Construct_UClass_ACBullet();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACBullet_OnHit_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// Capsule???? Hit?\xc8\xb0??? ???\xce\xb5?\n" },
		{ "ModuleRelativePath", "Weapons/CBullet.h" },
		{ "ToolTip", "Capsule???? Hit?\xc8\xb0??? ???\xce\xb5?" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACBullet_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACBullet_OnHit, "OnHit" }, // 2077977068
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACBullet_Statics::Class_MetaDataParams[] = {
		{ "Comment", "// \xc8\xad??,Bullet?? ??????\xc5\xb8?? ?\xcc\xbf??\xcf\xbf??? ?\xd1\xb4?\n" },
		{ "IncludePath", "Weapons/CBullet.h" },
		{ "ModuleRelativePath", "Weapons/CBullet.h" },
		{ "ToolTip", "\xc8\xad??,Bullet?? ??????\xc5\xb8?? ?\xcc\xbf??\xcf\xbf??? ?\xd1\xb4?" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACBullet_Statics::NewProp_Capsule_MetaData[] = {
		{ "Category", "CBullet" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Weapons/CBullet.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACBullet_Statics::NewProp_Capsule = { "Capsule", nullptr, (EPropertyFlags)0x00400000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACBullet, Capsule), Z_Construct_UClass_UCapsuleComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACBullet_Statics::NewProp_Capsule_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACBullet_Statics::NewProp_Capsule_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACBullet_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x00400000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACBullet, Mesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACBullet_Statics::NewProp_Mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACBullet_Statics::NewProp_Mesh_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACBullet, 1042767946);
	template<> UC_RIFLE_API UClass* StaticClass<ACBullet>()
	{
		return ACBullet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACBullet(Z_Construct_UClass_ACBullet, &ACBullet::StaticClass, TEXT("/Script/UC_Rifle"), TEXT("ACBullet"), false, nullptr, nullptr, nullptr);
